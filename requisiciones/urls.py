...
urlpatterns = [
    ...
    path('requisiciones/requisiciones_productos', views.requisiciones_productos, name='requisiciones-productos'),
    ...
    path('sol_autorizadas_orden/requisicion_cancelar/<int:pk>/', views.requisicion_cancelar, name='requisicion-cancelar'), #pendiente revisar que esta vista esté siendo utilizada
    ...
    path('salida_material/solicitud_pdf/<int:pk>/', views.descargar_solicitud_pdf, name='solicitud-pdf'),
    path('salida_material/ver_solicitud_pdf/<int:pk>/', views.ver_solicitud_pdf, name='ver_solicitud_pdf'),
    ...
    path('verificar_estado_entradas/', views.verificar_estado_entradas, name='verificar_estado_entradas'),
    path('clear_task_id_entradas/', views.clear_task_id_entradas, name='clear_task_id_entradas'),
