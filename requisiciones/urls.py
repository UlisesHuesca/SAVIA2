...
urlpatterns = [
    ...
    path('update_devolucion_inventario/', views.update_devolucion_inventario, name='update-devolucion-inventario'),
    path('update_devolucion_apartado/', views.update_devolucion_apartado, name='update-devolucion-apartado'),
