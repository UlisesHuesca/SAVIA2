...
class Requis(models.Model):
    ...
    rejected_by = models.ForeignKey(Profile, on_delete = models.CASCADE, null=True, related_name ="compras") 
...
class ValeSalidas(models.Model):
    ...
    comentario = models.CharField(null=True, blank=True, max_length = 250)
