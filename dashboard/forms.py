...
class ProveedoresDireccionesForm(forms.ModelForm):
    class Meta:
        model = Proveedor_direcciones
        fields = ['estado','telefono','distrito','domicilio','contacto','email','email_opt','banco','swift','spid','clabe','cuenta','financiamiento','dias_credito','estatus','producto','servicio','arrendamiento','moneda','modificado_fecha','referencia','convenio','visita']
...
class Add_ProveedoresDireccionesForm(forms.ModelForm):
    class Meta:
        model = Proveedor_direcciones
        fields = ['domicilio','estado','distrito','contacto','telefono','email','email_opt','banco','swift','spid','clabe','cuenta','financiamiento','dias_credito','estatus','producto','visita','servicio','arrendamiento','referencia','convenio']
