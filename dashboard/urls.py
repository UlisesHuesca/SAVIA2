...
urlpatterns = [
    ...
    path('configuracion/proyectos_contrato/<int:pk>', views.proyectos_contrato, name='proyectos-contrato'),
    ...
    path('price-ref-pending/', views.price_ref_pending, name='price_ref_pending'),
    path('price-ref/authorize/<int:pk>/', views.price_ref_authorize, name='price_ref_authorize'),
    path('price-ref/reject/<int:pk>/', views.price_ref_reject, name='price_ref_reject'), 
    path('price-ref/history/', views.price_ref_history, name='price_ref_history'),
    path('precio-ref/pdf/<int:product_id>/', views.pdf_precio_referencia, name='precio_ref_pdf'),
    ...
    path("proveedores/reporte-vencimientos-excel/", views.reporte_vencimientos_excel, name="reporte_vencimientos_excel"),
