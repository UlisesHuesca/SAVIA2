...
# from dashboard.models import ArticulosparaSurtir  # Ajusta el import si es necesario
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Recupera todas las salidas completadas y no canceladas
        salidas = Salidas.objects.filter(cancelada=False, complete=True)

        for salida in salidas:
            total_salidas += 1
            articulo = salida.producto  # FK hacia ArticulosparaSurtir
