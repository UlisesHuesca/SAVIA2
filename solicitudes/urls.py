...
urlpatterns = [
    ...
    path('inventario/analisis_rotacion', views.analisis_rotacion, name='analisis-rotacion'),
    ...
    path('solicitud/select_product_quality/<int:pk>', views.select_product_quality, name='select-product-quality'),    
