...
from .models import Compra, ArticuloComprado, Comparativo, Item_Comparativo, Proveedor_direcciones
...
class CompraForm(forms.ModelForm):
    ...
    def __init__(self,*args, **kwargs):
        ...
        if 'comparativo' in self.data:
            try:
                seleccion_actual = int(self.data.get('comparativo'))
