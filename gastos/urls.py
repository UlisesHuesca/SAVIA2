...
urlpatterns = [
    ...
    path('gasto/cancelar_vale_rosa/<int:pk>', views.cancelar_vale_rosa, name='cancelar-vale-rosa'),
    ...
    path('vale-rosa/<int:vale_id>/<str:color>/pdf/', views.descargar_vale_rosa_pdf, name='descargar_vale_rosa_pdf'),
