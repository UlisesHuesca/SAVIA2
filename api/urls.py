...
urlpatterns = [
    ...
    path('compras-resumen-api/', views.compras_resumen_api, name='compras-resumen-api'),
    path('compras-resumen-excel/', views.compras_resumen_excel, name='compras_resumen_excel'),
    path('compras-resumen-chart-proveedores/', views.compras_resumen_chart_proveedores,name='compras_resumen_chart_proveedores'),
